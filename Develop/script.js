...
function generatePassword() {
  ...
  while(!validateCharTypeInput(charTypeInput)){
    ...
    //This helps with different user input, so "lowercase" and "lower    case" would both be valid inputs.
    charTypeInput = charTypeInput.replace(/\s/g, '');
  }
  console.log(charTypeInput);
  console.log(validateCharTypeInput(charTypeInput));
}
